 ...
 *
 * Difference:
 * Legacy aliases use quantized `anormtab` lookup (`shadedots`) and current-frame normals.
 * Cake mirrors that response while still sourcing normals from normal VAT.
 */
class Md2Shader(
