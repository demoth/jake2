...
class ClientEntityManager : Disposable {
    ...
    private val rDrawEntities = Cvar.getInstance().Get("r_drawentities", "1", 0, "Draw model entities")
    private val clGun = Cvar.getInstance().Get("cl_gun", "1", 0, "Draw the view weapon model")
