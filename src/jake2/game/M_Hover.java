...
// $Id: M_Hover.java,v 1.2 2004-07-08 15:58:44 hzi Exp $
...
public class M_Hover extends Game {
	...
	static mframe_t hover_frames_land[] = new mframe_t[] { new mframe_t(GameAIAdapters.ai_move, 0, null)};
	...
	static mframe_t hover_frames_start_attack[] =
		new mframe_t[] { new mframe_t(GameAIAdapters.ai_charge, 1, null), new mframe_t(GameAIAdapters.ai_charge, 1, null), new mframe_t(GameAIAdapters.ai_charge, 1, null)};
	...
	static mframe_t hover_frames_attack1[] =
		new mframe_t[] {
			new mframe_t(GameAIAdapters.ai_charge, -10, hover_fire_blaster),
			new mframe_t(GameAIAdapters.ai_charge, -10, hover_fire_blaster),
			new mframe_t(GameAIAdapters.ai_charge, 0, hover_reattack),
			};
	static mmove_t hover_move_attack1 = new mmove_t(FRAME_attak104, FRAME_attak106, hover_frames_attack1, null);

	static mframe_t hover_frames_end_attack[] = new mframe_t[] { new mframe_t(GameAIAdapters.ai_charge, 1, null), new mframe_t(GameAIAdapters.ai_charge, 1, null)};
