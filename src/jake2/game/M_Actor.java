...
// $Id: M_Actor.java,v 1.3 2003-11-29 13:28:29 rst Exp $
...
public class M_Actor extends GameAI {
	...
	static EntPainAdapter actor_pain= new EntPainAdapter() {
		public void pain(edict_t self, edict_t other, float kick, int damage) {
			...
			if ((other.client != null) && (random() < 0.4)) {
				...
				gi.cprintf(other, PRINT_CHAT, name + ": " + messages[rand() % 3] + "!\n");
				return;
			}
	...
	*/
	...
	static void SP_target_actor(edict_t self) {
		if (self.targetname != null)
			gi.dprintf(self.classname + " with no targetname at " + vtos(self.s.origin) + " \n");
