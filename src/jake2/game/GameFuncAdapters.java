	...
	static EntBlockedAdapter plat_blocked = new EntBlockedAdapter() {
		public void blocked(edict_t self, edict_t other) {
			if (0 == (other.svflags & Defines.SVF_MONSTER) && (null == other.client)) {
				...
				GameUtil.T_Damage(other, self, self, Globals.vec3_origin, other.s.origin, Globals.vec3_origin, 100000, 1, 0, Defines.MOD_CRUSH);
			...
			GameUtil.T_Damage(other, self, self, Globals.vec3_origin, other.s.origin, Globals.vec3_origin, self.dmg, 1, 0, Defines.MOD_CRUSH);
