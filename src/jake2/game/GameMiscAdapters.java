...
// $Id: GameMiscAdapters.java,v 1.1 2004-02-26 22:36:31 rst Exp $
	...
	*/
	...
	if (plane == null)
			...
			if (other.takedamage == Defines.DAMAGE_NO)
				return;
			GameUtil.T_Damage(other, self, self, Globals.vec3_origin, self.s.origin, Globals.vec3_origin, self.dmg, 1, 0, Defines.MOD_CRUSH);
		}
	};
