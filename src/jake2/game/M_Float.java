...
// $Id: M_Float.java,v 1.2 2004-07-08 15:58:44 hzi Exp $
...
public class M_Float extends Game {
	...
	static mframe_t floater_frames_attack1[]=
		new mframe_t[] { new mframe_t(GameAIAdapters.ai_charge, 0, null), // Blaster attack)
	...
	static mframe_t floater_frames_attack2[]=
		new mframe_t[] { new mframe_t(GameAIAdapters.ai_charge, 0, null), // Claws
		new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			...
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, floater_wham),
	...
	static mframe_t floater_frames_attack3[]=
		new mframe_t[] {
			...
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, floater_zap),
		//								-- LOOP Starts
		new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
			new mframe_t(GameAIAdapters.ai_charge, 0, null),
