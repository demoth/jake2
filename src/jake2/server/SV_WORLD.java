...
public class SV_WORLD extends SV_CCMDS
{
	...
	===============
	*/
	public static areanode_t SV_CreateAreaNode(
		int depth,
		float[] mins,
		float[] maxs)
	{
	...
	*/
	...
	================
	*/
	public static int SV_AreaEdicts(
		float[] mins,
		float[] maxs,
		edict_t list[],
		int maxcount,
	...
	*/
	public static void SV_ClipMoveToEntities(moveclip_t clip)
	{
		...
		for (i= 0; i < num; i++)
		{
			...
			if (0 == (clip.contentmask & CONTENTS_DEADMONSTER)
				&& 0 != (touch.svflags & SVF_DEADMONSTER))
				continue;
	...
	==================
	*/
	public static void SV_TraceBounds(
		float[] start,
		float[] mins,
		float[] maxs,
		float[] end,
	...
	==================
	*/
	public static trace_t SV_Trace(
		float[] start,
		float[] mins,
		float[] maxs,
		float[] end,
