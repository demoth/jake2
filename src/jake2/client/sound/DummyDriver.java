...
public final class DummyDriver implements Sound {
	...
	/* (non-Javadoc)
	 * @see jake2.client.sound.Sound#Init()
	 */
	public boolean Init() {
		return true;
	}
	...
	/* (non-Javadoc)
	 * @see jake2.client.sound.Sound#Shutdown()
	 */
	...
	/* (non-Javadoc)
	 * @see jake2.client.sound.Sound#StartSound(float[], int, int, jake2.client.sound.sfx_t, float, float, float)
	 */
	public void StartSound(float[] origin, int entnum, int entchannel, sfx_t sfx, float fvol, float attenuation, float timeofs) {
	}

	/* (non-Javadoc)
	 * @see jake2.client.sound.Sound#Update(float[], float[], float[], float[])
	 */
    ...
    /* (non-Javadoc)
	 * @see jake2.client.sound.Sound#StopAllSounds()
	 */
