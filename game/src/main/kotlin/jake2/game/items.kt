...
*/
fun itemHealthMedium(self: GameEntity, game: GameExportsImpl) {
 ...
 */
fun itemHealthSmall(self: GameEntity, game: GameExportsImpl) {
 ...
 */
fun itemHealthLarge(self: GameEntity, game: GameExportsImpl) {
 ...
 */
fun itemHealthMega(self: GameEntity, game: GameExportsImpl) {
    spawnHealth(self, game, "models/items/mega_h/tris.md2", "items/m_health.wav", 100, true, true)
}


private fun spawnHealth(self: GameEntity, game: GameExportsImpl, model: String, sound: String, amount: Int, ignoreHealth: Boolean = false, timed: Boolean = false) {
