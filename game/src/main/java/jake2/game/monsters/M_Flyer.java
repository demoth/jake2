...
public class M_Flyer {
    ...
    static void flyer_fire(GameEntity self, int flash_number, GameExportsImpl gameExports) {
        float[] start = { 0, 0, 0 };
     ...
     * Trigger_Spawn Sight
     */
    public static void SP_monster_flyer(GameEntity self, GameExportsImpl gameExports) {
